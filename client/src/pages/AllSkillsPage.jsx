...
import { FaCss3Alt, FaGlobe } from "react-icons/fa";
...
const allSkills = [
  {
    ...
    color: "#F7DF1E",
    category: "Language",
    description: "Used for dynamic web apps and front-end interactivity.",
    level: 4,
  },
  {
    name: "Python",
    ...
    color: "#3776AB",
    category: "Language",
    description: "Great for automation, data science, and backend APIs.",
    level: 2.5,
  },
  {
    name: "C++",
    ...
    color: "#00599C",
    category: "Language",
    description: "Used for high-performance applications and algorithms.",
    level: 4,
  },
  {
    name: "React",
    ...
    color: "#61DAFB",
    category: "Frontend",
    description: "Builds reactive UI components efficiently.",
    level: 4,
  },
  {
    name: "Tailwind CSS",
  ...
  },
  {
    ...
    color: "#E34F26",
    category: "Frontend",
    description: "Semantic markup for modern web pages.",
    level: 4.5,
  },
  {
    name: "CSS3",
