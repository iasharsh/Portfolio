...
const socials = [
  ...
  },
  {
    ...
    href: "mailto:iasharsh34@gmail.com",
    color: "hover:border-red-400 hover:text-red-400",
  },
  {
    label: "Instagram",
    icon: <FaInstagram size={16} />,
    href: "https://www.instagram.com/__harsh.pandey__",
    color: "hover:border-pink-500 hover:text-pink-400",
  },
];

const inputClass =
  "w-full px-4 py-3 rounded-xl border border-[var(--border)] bg-[var(--card)] text-sm text-[var(--text)] placeholder:text-[var(--muted)] focus:outline-none focus:border-[var(--accent)] transition-colors duration-200";
const labelClass =
  "text-xs font-semibold text-[var(--muted)] uppercase tracking-wider mb-2 block";
...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="min-h-screen pt-20 pb-3 px-6 bg-[var(--bg)]"
    >
        ...
        >
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              className="w-full px-6 py-3.5 bg-[var(--text)] text-[var(--bg)] text-sm font-semibold rounded-xl hover:opacity-90 transition-all duration-200 disabled:opacity-60 cursor-pointer"
            >
              {sending
                ? "Sending..."
                : sent
          ...
          >
            ...
            >
              ...
              <p className="text-xs text-[var(--muted)] leading-relaxed">
                Currently looking for internship and entry-level full stack
                developer roles. If you have an opportunity, I'd love to hear
                from you!
              </p>
            </motion.div>
